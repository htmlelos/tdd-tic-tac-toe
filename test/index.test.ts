...
describe('Juego', () => {
  ...
  test('Deberia declarar empate si todas las casillas estan ocupadas y no hay ganadores', () => {
    const gameStatus1 = play(0)(game)
    const gameStatus2 = play(1)(gameStatus1)
    const gameStatus3 = play(2)(gameStatus2)
    const gameStatus4 = play(3)(gameStatus3)
    const gameStatus5 = play(4)(gameStatus4)
    const gameStatus6 = play(5)(gameStatus5)
    const gameStatus7 = play(6)(gameStatus6)
    const gameStatus8 = play(7)(gameStatus7)
    const gameStatus9 = play(8)(gameStatus8)
    const status = getGameStatus(gameStatus9)
